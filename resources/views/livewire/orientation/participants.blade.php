                    ...
                    <table class="min-w-full divide-y divide-gray-200 ">
                        ...
                        <tbody class="bg-white  divide-y divide-gray-200 ">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-4">
                                        @if ($participant->checkOrientationCompleted($orientation->id) == false)
                                            {{-- <button wire:click="detach({{$participant->id}})" class="text-red-600 hover:text-red-800 ">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-xs uppercase px-2 rounded border border-red-200 bg-red-50 text-red-600">{{__("Pending")}}</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-4">
                                        <button wire:click="notify('{{$invitation->email}}')" class="text-gray-600  hover:text-gray-900  filter rotate-90">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
