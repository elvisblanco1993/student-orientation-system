<div>
    ...
    <div class="grid grid-cols-3 gap-8 mb-8">
        <div class="col-span-3 sm:col-span-1">
            <div class="w-full p-6 rounded-lg border border-gray-200   flex items-center justify-between">
                <div class="">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-gray-700 " viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 ">
                        ...
                        <tbody class="bg-white  divide-y divide-gray-200 ">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap ">
                                    <div class="w-full">
                                        <div class="shadow w-full bg-gray-100  rounded-xl">
